...
{   JFrame jf;
	...
	public MainMenu()
	{
		...
		l1=new JLabel("WELCOME TO MEDICAL STOCK ");
		...
		mbar.add(m2);
		m2_1 = new JMenuItem("Add New Medicine",new ImageIcon("src/images//addnew.png"));
		m2.add(m2_1);
		m2_2 = new JMenuItem("search Medicine",new ImageIcon("src/images//search.png"));
		m2.add(m2_2);
		m2_3 = new JMenuItem("Update Medicine",new ImageIcon("src/images//update.png"));
		m2.add(m2_3);
		m2_4 = new JMenuItem("Delete Medicine",new ImageIcon("src/images//delete.png"));
		m2.add(m2_4);
	    m2_5 = new JMenuItem("Stock of Medicine",new ImageIcon("src/images//all.png"));
		m2.add(m2_5);
		...
		m3_2 = new JMenuItem("Suplier wise medicine Report",new ImageIcon("src/images//report.png"));
		m3.add(m3_2);

		m4=new JMenu("About");
		mbar.add(m4);
		m4_1 = new JMenuItem("About System",new ImageIcon("src/images//help.png"));
		m4.add(m4_1);
		...
		ImageIcon back_image1=new ImageIcon("src/images//meed.jpg");
        Image img=back_image1.getImage();
        Image tem_image=img.getScaledInstance(1250,700,Image.SCALE_SMOOTH);
        back_image1=new ImageIcon(tem_image);
        JLabel background=new JLabel("",back_image1,JLabel.CENTER);
