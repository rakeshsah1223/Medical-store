...
class Login extends JFrame implements ActionListener
{
	...
	Login()
	{
		...
		ImageIcon back_image=new ImageIcon("src/images//me.jpg");
        Image img=back_image.getImage();
        Image tem_image=img.getScaledInstance(800,600,Image.SCALE_SMOOTH);
        back_image=new ImageIcon(tem_image);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			try
			{
				...
				if((s.compareTo("rakesh")==0)&&(s1.compareTo("rakesh123")==0))
				{
